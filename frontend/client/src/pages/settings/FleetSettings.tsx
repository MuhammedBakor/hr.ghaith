...
export default function FleetSettings() {
  ...
  const moduleSettings = settings.filter((s: any) => 
    String(s.key || s.name || '').toLowerCase().includes('fleet')
  );
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">إعدادات الأسطول</h1>
      ...
      {isLoading ? (
        ...
        <Card>
          <CardHeader><CardTitle>إعدادات الأسطول</CardTitle></CardHeader>
