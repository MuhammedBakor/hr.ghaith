  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">حدود العمليات</h1>
      ...
      {!isLoading && !isError && (
        <Card>
          <CardHeader><CardTitle className="flex gap-2">حدود العمليات <Badge variant="secondary">{filtered.length}</Badge></CardTitle></CardHeader>
          <CardContent>
